...
*/
    ...
    a.parent &&
      ...
      a.atRule
        ? 0 === c.indexOf("@media")
          ? (a.type = ha)
          : c.match(ia) &&
            ((a.type = q), (a.keyframesName = a.selector.split(fa).pop()))
  ...
  function ya(a, b, c) {
    ...
    C
      ? a.compareDocumentPosition(C) === Node.DOCUMENT_POSITION_PRECEDING &&
        (C = a)
      : (C = a);
  }
  function D(a, b) {
  ...
  I.prototype.b = function (a, b, c) {
    ...
    a = a.replace(Pa, function (a, d, f) {
      e || ((a = Qa(f, d, b, c)), (e = e || a.stop), (d = a.G), (f = a.value));
      return d + f;
    });
    f && (a = Na(a, g));
    d && (a = Ja(a));
  ...
  function eb(a, b, c, e) {
    ...
    if (b.f.j) {
      ...
      if (g || h)
        ((c = d),
          h &&
            (b.g || (b.g = Ia(K, b, K.b, a ? "." + a : "", d)), (c = b.g || d)),
          e({ A: c, K: h, S: g }));
    }
  }
  function fb(a, b, c) {
        ...
        if (!r && !xa(b) && b.cssText) {
          ...
          if (b.C)
            if (null == b.u) {
              b.u = [];
              for (var m in l)
                ((h = l[m]), (h = h(d)), d !== h && ((d = h), b.u.push(m)));
            } else {
              for (m = 0; m < b.u.length; ++m) ((h = l[b.u[m]]), (d = h(d)));
              h = d;
            }
          b.cssText = h;
          b.g = b.g || b.selector;
  ...
  function jb(a, b) {
    ...
    a.textContent = y(e, function (a) {
      ...
      a.f &&
        a.f.cssText &&
        ((d = d.replace(ma, "").replace(na, "")), (a.cssText = cb(c, d, b)));
    });
  }
        ...
        for (var e = 0; e < c.addedNodes.length; e++) {
          ...
          if (d.nodeType === Node.ELEMENT_NODE) {
            ...
            if (
              g &&
              f === d.ownerDocument &&
              (("style" !== d.localName && "template" !== d.localName) ||
                "" === H(d))
            )
              Fa(d, g);
  ...
  k.prepareTemplateStyles = function (a, b, c) {
    if (!a._prepared) {
      ...
      for (
        ...
        if (l.hasAttribute("shady-unscoped")) {
          if (!r) {
            var m = l.textContent;
            wa.has(m) ||
              (wa.add(m), (m = l.cloneNode(!0)), document.head.appendChild(m));
      ...
      if (!d) {
        if ((g = !e))
          ((g = x.test(f) || w.test(f)), (x.lastIndex = 0), (w.lastIndex = 0));
        h = p(f);
  ...
  function Eb(a, b) {
    return (b = F(b).getRootNode().host) ? (P(b) || Bb(b) ? b : Eb(a, b)) : a.c;
  }
  function Db(a, b, c) {
    var e = Eb(a, b),
      d = P(e),
