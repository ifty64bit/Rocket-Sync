...
*/
  ...
  window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss
    ...
    : window.ShadyCSS
      ? (r(window.ShadyCSS), (window.ShadyCSS = void 0))
    ...
    if (a.cssText || a.rules) {
      ...
      if (f) {
        ...
        (b
          ? (b = a.cssText)
          : ((b = a.cssText),
            (b = b.replace(ea, "").replace(fa, "")),
            (b = b.replace(ha, "").replace(ia, ""))),
          (e = b.trim()) && (e = "  " + e + "\n"));
    }
    e &&
  ...
  R.prototype.m = function (a, b) {
    if (void 0 === a._gatheredStyle) {
      var c = [];
      for (
        var e = a.content.querySelectorAll("style"), d = 0;
        d < e.length;
        d++
      ) {
        var f = e[d];
    ...
    for (var e; (e = H.exec(b)); ) {
      ...
      if (m) {
        ...
        for (d in q)
          ((k = h && h[d]),
            (m = [d, ": var(", f, "_-_", d]),
            k && m.push(",", k.replace(O, "")),
            m.push(")"),
            O.test(q[d]) && m.push(" !important"),
            n.push(m.join("")));
      }
      d = n.join("; ");
      b = g + d + b;
  ...
  W.prototype.styleElement = function (a) {
    ...
    b = U[c];
    if (!((b && "" !== N(b)) || !b || sa(b))) {
      if (sa(b) || b._applyShimValidatingVersion !== b._applyShimNextVersion)
        (this.prepareTemplate(b, c), ta(b));
      if ((a = a.shadowRoot))
  ...
  if (!window.ShadyCSS || !window.ShadyCSS.ScopingShim) {
    var Y = new W(),
      ua = window.ShadyCSS && window.ShadyCSS.CustomStyleInterface;
    window.ShadyCSS = {
    ...
    ua && (window.ShadyCSS.CustomStyleInterface = ua);
  }
